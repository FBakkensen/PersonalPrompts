...
**I. Project Overview and Initial Setup (`aldocs/01_project_overview.md`):**
...
**II. Codebase Structure and Conventions (`aldocs/02_codebase_structure.md`):**
...
**III. Architectural Analysis (`aldocs/03_architecture.md`):**
...
**IV. Data Model Analysis (`aldocs/04_data_model.md`):**

1.  **Core Entities and Relationships:**
    *   Identify the top 10-15 most important custom tables in the project. For each table, list its primary key and 5-10 most significant fields (excluding system fields like SystemId, SystemCreatedAt unless highly relevant to custom logic).
...
**V. Key Functionalities and Business Logic Flows (`aldocs/05_key_flows.md`):**

1.  **Identification of Core Processes:**
    *   Based on object names, comments, and code structure, identify 3-5 critical business processes or user workflows implemented or significantly modified by this extension.
...
3.  **Flow Diagrams (for each identified process):**
    *   Generate a **Mermaid Sequence Diagram or Activity Diagram** for each of the 3-5 critical flows. Choose the diagram type that best represents the flow. Be precise with object and method names.
...
**VI. Eventing Model and Extensibility (`aldocs/06_eventing_extensibility.md`):**
...
**VII. Integrations (`aldocs/07_integrations.md`):**
...
**VIII. Code Quality and Best Practices Assessment (`aldocs/08_code_quality.md`):**
...
**IX. Suggested Diagrams (Beyond ERD and Flows) (`aldocs/09_suggested_diagrams.md`):**

1.  Based on your comprehensive analysis, suggest 2-3 *additional* diagram types (beyond the ERD and Flow Diagrams already mandated) that would be particularly beneficial for understanding *this specific codebase*. For each suggestion:
...
**X. Onboarding Summary and Next Steps (`aldocs/10_onboarding_summary.md`):**
...
*   Create a root folder named `aldocs`.
*   Inside `aldocs`, create the specified Markdown files (e.g., `01_project_overview.md`, `02_codebase_structure.md`, etc.).
